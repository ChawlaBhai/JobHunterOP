#!/usr/bin/env node
/**
 * gemini-eval.mjs — Gemini-powered Job Offer Evaluator for jobhunter-op
 *
...
const PATHS = {
  ...
  evaluate:    join(ROOT, '.claude', 'skills', 'jobhunter-op', 'SKILL.md'),
  cv:          join(ROOT, 'cv.md'),
...
if (args.length === 0 || args[0] === '--help' || args[0] === '-h') {
  console.log(`
╔══════════════════════════════════════════════════════════════════╗
║           jobhunter-op — Gemini Evaluator (free-tier)             ║
╚══════════════════════════════════════════════════════════════════╝
...
// ---------------------------------------------------------------------------
const systemPrompt = `You are jobhunter-op, an AI-powered job search assistant.
