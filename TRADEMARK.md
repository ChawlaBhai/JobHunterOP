# jobhunter-op Trademark Policy

This document explains how the "jobhunter-op" name and brand may be used.
...
- **In doubt? Ask.** hi@bidi-bhai.github.io, subject `Trademark request`.
...
"jobhunter-op," its visual identity, or any associated brand assets.
Those are reserved by the project's maintainer, Bidi Fernández de
...
- **Describing compatibility, origin, and lineage** — "works with
  jobhunter-op," "based on jobhunter-op," "fork of jobhunter-op," "extends
  jobhunter-op" are all welcome and encouraged with attribution.
- **Naming a fork distinctly** — pick your own product name; mention
  jobhunter-op as origin if you like.
...
- **Product, service, or company names** that include "jobhunter-op" or
  close variants. This includes prefixes, suffixes, and capitalizations:
  "jobhunter-op Cloud," "jobhunter-op Pro," "jobhunter-op SaaS," "JobHunterOP
  Hosted," "CareerOps by [vendor]," "Cloud jobhunter-op," etc.
- **Endorsement, sponsorship, or affiliation claims** in any context:
  "Powered by jobhunter-op," "Official jobhunter-op," "Sponsored by
  jobhunter-op," "Partner of jobhunter-op," "Featured by jobhunter-op," and
  similar phrasings.
- **Domain names, social handles, and app store listings** containing
  "jobhunter-op" or close variants for commercial purposes.
...
- **Compatibility certifications** that imply official testing or
  approval ("jobhunter-op Certified," "jobhunter-op Verified").
...
Email **hi@bidi-bhai.github.io** with subject **"Trademark request — [your use case]"**
and include:
...
jobhunter-op is a community-built project used by tens of thousands of
...
© 2026 Bidi Bhai. "jobhunter-op"™ is a trademark of
Bidi Bhai. A trademark application has been filed
