# jobhunter-op — Türkçe Modlar (`modes/tr/`)

Bu klasör, Türkiye iş piyasasında iş arayanlar veya Türkçe ilanlarla çalışanlar için jobhunter-op modlarının Türkçe çevirilerini içerir.
