...
5. **jobhunter-op proof point** : inclure dans "Informations complementaires" si un tel champ existe
...
3. Suggerer l'etape suivante : `/jobhunter-op contacto` pour du LinkedIn outreach vers le hiring manager
