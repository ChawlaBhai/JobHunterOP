# Geteilter Kontext -- jobhunter-op (Deutsch)

<!-- ============================================================
     ANPASSEN DIESER DATEI
     ============================================================
     Diese Datei enthält den geteilten Kontext für alle jobhunter-op-Modi
     in der deutschen Variante. Bevor du jobhunter-op verwendest, MUSST du:
