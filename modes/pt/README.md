# jobhunter-op -- Modos em Português BR (`modes/pt/`)

Esta pasta contém as traduções em português brasileiro dos principais modos do jobhunter-op para candidatos que buscam vagas no mercado brasileiro ou em empresas que operam em português.
...
O jobhunter-op não tem um "switch de idioma" como flag de código. Em vez disso, existem dois caminhos:
