# Contributing to JobHunterOP

Thanks for your interest in contributing! JobHunterOP is built with Claude Code, and you can use it for development too.
...
- Report bugs via [Issues](https://github.com/bidi-bhai/JobHunterOP/issues)
...
- **PRs that enable auto-submitting applications** without human review. jobhunter-op is a decision-support tool, not a spam bot.
...
The "jobhunter-op" name itself is governed by [TRADEMARK.md](TRADEMARK.md).
...
- [Open an issue](https://github.com/bidi-bhai/JobHunterOP/issues)
