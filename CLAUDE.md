# JobHunterOP -- AI Job Search Pipeline

## Origin

This system was built and used by [bidi-bhai](https://bidi-bhai.github.io) to evaluate 740+ job offers, generate 100+ tailored CVs, and land a Head of Applied AI role. The archetypes, scoring logic, negotiation scripts, and proof point structure all reflect his specific career search in AI/automation roles.

The portfolio that goes with this system is also open source: [cv-bidi](https://github.com/bidi-bhai/cv-bidi).
...
- `{"status": "update-available", "local": "1.0.0", "remote": "1.1.0", "changelog": "..."}` → tell the user:
  > "jobhunter-op update available (v{local} → v{remote}). Your data (CV, profile, tracker, reports) will NOT be touched. Want me to update?"
...
The user can also say "check for updates" or "update jobhunter-op" at any time to force a check.
To rollback: `node update-system.mjs rollback`

## What is jobhunter-op
...
|---------|------------------------|-------------|
| `/jobhunter-op` | `/jobhunter-op` | Show menu or evaluate JD with args |
| `/jobhunter-op-pipeline` | `/jobhunter-op pipeline` | Process pending URLs from inbox |
| `/jobhunter-op-evaluate` | `/jobhunter-op oferta` | Evaluate job offer (A-F scoring) |
| `/jobhunter-op-compare` | `/jobhunter-op ofertas` | Compare and rank multiple offers |
| `/jobhunter-op-contact` | `/jobhunter-op contacto` | LinkedIn outreach (find contacts + draft) |
| `/jobhunter-op-deep` | `/jobhunter-op deep` | Deep company research |
| `/jobhunter-op-pdf` | `/jobhunter-op pdf` | Generate ATS-optimized CV |
| `/jobhunter-op-latex` | `/jobhunter-op latex` | Export CV as LaTeX/Overleaf .tex |
| `/jobhunter-op-training` | `/jobhunter-op training` | Evaluate course/cert against goals |
| `/jobhunter-op-project` | `/jobhunter-op project` | Evaluate portfolio project idea |
| `/jobhunter-op-tracker` | `/jobhunter-op tracker` | Application status overview |
| `/jobhunter-op-apply` | `/jobhunter-op apply` | Live application assistant |
| `/jobhunter-op-scan` | `/jobhunter-op scan` | Scan portals for new offers |
| `/jobhunter-op-batch` | `/jobhunter-op batch` | Batch processing with parallel workers |
| `/jobhunter-op-patterns` | `/jobhunter-op patterns` | Analyze rejection patterns and improve targeting |
| `/jobhunter-op-followup` | `/jobhunter-op followup` | Follow-up cadence tracker |

**Note:** OpenCode commands invoke the same `.claude/skills/jobhunter-op/SKILL.md` skill used by Claude Code. The `modes/*` files are shared between both platforms.
...
| `/jobhunter-op` | `/jobhunter-op` | Show menu or evaluate JD with args |
| `/jobhunter-op-pipeline` | `/jobhunter-op pipeline` | Process pending URLs from inbox |
| `/jobhunter-op-evaluate` | `/jobhunter-op oferta` | Evaluate job offer (A-G scoring) |
| `/jobhunter-op-compare` | `/jobhunter-op ofertas` | Compare and rank multiple offers |
| `/jobhunter-op-contact` | `/jobhunter-op contacto` | LinkedIn outreach (find contacts + draft) |
| `/jobhunter-op-deep` | `/jobhunter-op deep` | Deep company research |
| `/jobhunter-op-pdf` | `/jobhunter-op pdf` | Generate ATS-optimized CV |
...
> - Run `/jobhunter-op scan` (or `/jobhunter-op-scan` if using OpenCode) to search portals
> - Run `/jobhunter-op` to see all commands
>
> Everything is customizable — just ask me to change anything.
>
> Tip: Having a personal portfolio dramatically improves your job search. If you don't have one yet, the author's portfolio is also open source: github.com/bidi-bhai/cv-bidi — feel free to fork it and make it yours."

Then suggest automation:
> "Want me to scan for new offers automatically? I can set up a recurring scan every few days so you don't miss anything. Just say 'scan every 3 days' and I'll configure it."

If the user accepts, use the `/loop` or `/schedule` skill (if available) to set up a recurring `/jobhunter-op scan` (or `/jobhunter-op-scan` if using OpenCode). If those aren't available, suggest adding a cron job or remind them to run `/jobhunter-op scan` (or `/jobhunter-op-scan` if using OpenCode) periodically.
