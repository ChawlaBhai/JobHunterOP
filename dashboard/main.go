...
import (
	...
	"github.com/bidi-bhai/jobhunter-op/dashboard/internal/data"
	"github.com/bidi-bhai/jobhunter-op/dashboard/internal/model"
	"github.com/bidi-bhai/jobhunter-op/dashboard/internal/theme"
	"github.com/bidi-bhai/jobhunter-op/dashboard/internal/ui/screens"
)
...
func main() {
	pathFlag := flag.String("path", ".", "Path to jobhunter-op directory")
	flag.Parse()
