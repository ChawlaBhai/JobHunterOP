...
/**
 * update-system.mjs — Safe auto-updater for jobhunter-op
 *
...
const CANONICAL_REPO = 'https://github.com/bidi-bhai/JobHunterOP.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/bidi-bhai/jobhunter-op/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/bidi-bhai/jobhunter-op/releases/latest';
    ...
    [versionResult, releaseResult] = await Promise.allSettled([
      ...
      fetch(RELEASES_API, {
        headers: {
          ...
          'User-Agent': 'jobhunter-op-update-checker',
        },
...
async function apply() {
  ...
  try {
    ...
    // See: https://github.com/bidi-bhai/JobHunterOP/issues/649
