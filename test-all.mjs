...
/**
 * test-all.mjs — Comprehensive test suite for jobhunter-op
 *
...
const systemFiles = [
  ...
  '.claude/skills/jobhunter-op/SKILL.md',
];
...
const leakPatterns = [
  'Bidi', 'bidi-bhai.github.io', 'Santifer iRepair', 'Zinkee', 'ALMAS',
  'hi@bidi-bhai.github.io', '688921377', '/Users/bidi-bhai/',
];

const scanExtensions = ['md', 'yml', 'html', 'mjs', 'sh', 'go', 'json'];
const allowedFiles = [
  // English README + localized translations (all legitimately credit Bidi)
