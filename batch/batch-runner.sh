...
# jobhunter-op batch runner — standalone orchestrator for claude -p workers
...
usage() {
  cat <<'USAGE'
jobhunter-op batch runner — process job offers in batch via claude -p workers
...
main() {
  ...
  echo "=== jobhunter-op batch runner ==="
